package com.magento.softwaretestingboard.propertyreader;
...
public class PropertyReader {
    ...
    */
     ...
     * @return
     */
    public static synchronized PropertyReader getInstance() { //important method
     ...
     * @return
     */
    public String getProperty(String propertyName) {  //imp method
